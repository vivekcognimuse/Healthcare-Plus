...
const CrumplerHealthForm = () => {
  ...
  return (
    <ModalWrapper isOpen={showFormModal} onClose={closeFormModal}>
      <div
        ref={modalContentRef}
        className="w-full h-screen overflow-y-auto modal-scrollbar modal-container">
        <div className="w-full min-h-full bg-[url('/assets/contactImage.webp')] bg-cover bg-no-repeat bg-center">
          <div className="w-full min-h-full bg-white/60 backdrop-blur-[30px] flex items-center justify-center">
            <div className="p-8 max-w-[1480px] w-full mx-auto rounded-lg my-8">
